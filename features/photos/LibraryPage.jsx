...
export default function LibraryPage() {
  ...
  async function curatePhoto(filePath, isTrashed, rating) {
    try {
  ...
  function handleAcceptClick() {
    ...
    curatePhoto(photos[selectedIndex].filePath, false, 0);
  }
  ...
  function handleRejectClick() {
    ...
    curatePhoto(photos[selectedIndex].filePath, true, 0);
  }
  ...
  function handleRateClick(rating) {
    ...
    curatePhoto(photos[selectedIndex].filePath, false, rating);
  }
  ...
  if (error) {
    ...
    if (viewMode === 'sessions') {
      content = <SessionGallery photos={photos} sessions={sessions} selectedIndex={selectedIndex} onPhotoSelect={handlePhotoSelect} fadingPhotos={fadingPhotos} onUndo={handleUndo} />;
    } else {
      content = <PhotoGallery photos={photos} selectedIndex={selectedIndex} onPhotoSelect={handlePhotoSelect} fadingPhotos={fadingPhotos} onUndo={handleUndo} />;
    }
  }
